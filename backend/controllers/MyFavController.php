...
use backend\models\MyFavSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MyFavController implements the CRUD actions for MyFav model.
 */
class MyFavController extends Controller
{
    ...
    /**
     * Lists all MyFav models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MyFavSearch();
    ...
    /**
     * Updates an existing MyFav model.
    ...
    /**
     * Deletes an existing MyFav model.
    ...
    /**
     * Finds the MyFav model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @param string $users_id
     * @param string $vehicle_users_id
     * @param string $vehicle_id
     * @return MyFav the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id, $users_id, $vehicle_users_id, $vehicle_id)
    {
        if (($model = MyFav::findOne(['id' => $id, 'users_id' => $users_id, 'vehicle_users_id' => $vehicle_users_id, 'vehicle_id' => $vehicle_id])) !== null) {
            return $model;
        } else {
