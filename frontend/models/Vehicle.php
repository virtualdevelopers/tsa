...
class Vehicle extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'bidding_price' => 'Base Price',
            'garage_id' => 'Garage ID',
            'time_start'=> 'Auction Start Date',
            'time_left' => 'Auction End Date',
