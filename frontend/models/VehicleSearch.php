...
class VehicleSearch extends Vehicle
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'make', $this->make])
            ...
            ->andFilterWhere(['like', 'time_left', $this->time_start])
